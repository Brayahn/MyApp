...
class PriceListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price_list" do
    assert_difference('PriceList.count') do
      post price_lists_url, params: { price_list: { price: @price_list.price, product: @price_list.product, vendor: @price_list.vendor } }
    end
  ...
  test "should update price_list" do
    patch price_list_url(@price_list), params: { price_list: { price: @price_list.price, product: @price_list.product, vendor: @price_list.vendor } }
